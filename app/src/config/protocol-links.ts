export const GITHUB_URL = "https://github.com/Figu3/diem-relay";
...
export const AUDIT_BRIEF_URL = `${GITHUB_URL}/blob/main/contracts/AUDIT.md`;
export const KNOWN_ISSUES_URL = `${GITHUB_URL}/blob/main/contracts/KNOWN_ISSUES.md`;
